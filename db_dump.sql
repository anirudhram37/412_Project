...
--
-- Name: order_info; Type: TABLE; Schema: public; Owner: anirudhramasubramanian
--
...
CREATE TABLE public.order_info (
    ...
    userdata_name character varying(2083),
    date date
);


ALTER TABLE public.order_info OWNER TO anirudhramasubramanian;

--
-- Name: payment; Type: TABLE; Schema: public; Owner: anirudhramasubramanian
--
...
ALTER TABLE public.payment OWNER TO anirudhramasubramanian;

--
-- Name: price; Type: TABLE; Schema: public; Owner: anirudhramasubramanian
--
...
ALTER TABLE public.price OWNER TO anirudhramasubramanian;

--
-- Name: product; Type: TABLE; Schema: public; Owner: anirudhramasubramanian
--
...
ALTER TABLE public.product OWNER TO anirudhramasubramanian;

--
-- Name: reviews; Type: TABLE; Schema: public; Owner: anirudhramasubramanian
--
...
ALTER TABLE public.reviews OWNER TO anirudhramasubramanian;

--
-- Name: supplier; Type: TABLE; Schema: public; Owner: anirudhramasubramanian
--
...
ALTER TABLE public.supplier OWNER TO anirudhramasubramanian;

--
-- Name: user_data; Type: TABLE; Schema: public; Owner: anirudhramasubramanian
--
...
ALTER TABLE public.user_data OWNER TO anirudhramasubramanian;

--
-- Data for Name: order_info; Type: TABLE DATA; Schema: public; Owner: anirudhramasubramanian
--

COPY public.order_info (id, product_id, userdata_address, payment_card, payment_id, userdata_name, date) FROM stdin;
1	B002PD61Y4	123 Main St	1234567	John Doe	2023-10-19	\N
2	B002SZEOLG	456 Elm St	9876543	Jane Smith	2023-10-20	\N
3	B003B00484	789 Oak St	2345678	Michael Johnson	2023-10-21	\N
4	B003L62T7W	101 Pine St	5432109	Emily Davis	2023-10-22	\N
5	B004IO5BMQ	202 Cedar St	6789012	Robert Wilson	2023-10-23	\N
6	B005FYNT3G	303 Maple St	3456789	Sarah Brown	2023-10-24	\N
7	B005LJQMCK	404 Birch St	4321098	William Lee	2023-10-25	\N
8	B005LJQMZC	505 Redwood St	8901234	Linda Hall	2023-10-26	\N
9	B006LW0WDQ	606 Spruce St	1234567	Daniel Adams	2023-10-27	\N
10	B0073QGKAS	707 Willow St	7654321	Jessica White	2023-10-28	\N
\.


--
-- Data for Name: payment; Type: TABLE DATA; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Data for Name: price; Type: TABLE DATA; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Data for Name: product; Type: TABLE DATA; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Data for Name: reviews; Type: TABLE DATA; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Data for Name: supplier; Type: TABLE DATA; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Data for Name: user_data; Type: TABLE DATA; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: order_info order_info_pkey; Type: CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: payment payment_pkey; Type: CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: price price_pkey; Type: CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: product product_pkey; Type: CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: reviews reviews_pkey; Type: CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: supplier supplier_pkey; Type: CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: user_data user_data_pkey; Type: CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: order_info order_info_payment_card_payment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: order_info order_info_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: payment payment_userdata_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: price price_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: reviews reviews_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: reviews reviews_userdata_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
...
--
-- Name: supplier supplier_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: anirudhramasubramanian
--
